 ...
 * @see #getImage(int)
 */
public class ScaledImageList extends AbstractImageList<Image> implements MouseListener,
    ...
    public synchronized void addImage(Image img, String title, int width, int heigth) {
        ...
        if (img instanceof BufferedImage) {
            ScaleImage.Rectangle preferedSize = ScaleImage.fitToRect(new ScaleImage.Rectangle(0, 0, width, heigth),
                    (BufferedImage) img);
